...
sys.path.append(os.path.abspath(os.path.join(os.path.dirname("C:\\Users\\IdeaPad\\OneDrive\\Documenti\\PaintBall\\UnitTest\\testSwitch.py"), '..')))
import NSController as ns  # Sostituisci con il tuo modulo per la gestione del controller Nintendo Switch

class TestNintendoSwitchController(unittest.TestCase):
    def setUp(self):
        pygame.init()
        self.ns_controller = ns.NSController()

    def tearDown(self):
        self.ns_controller.close()

    def test_get_input(self):
        input_values = self.ns_controller.get_input()
    ...
    def test_generate_xml(self):
        ...
        for i, button_state in enumerate(input_values[2:]):  # Gli indici 2 in poi sono i pulsanti
        ...
        tree.write("C:\\GameMultiPlatform\\SetupController\\ns_controller_properties.xml")
